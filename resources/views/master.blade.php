    ...
    <div class="nav-bottom-sec">
        <ul class="left-navigation" id="left-navigation">
           ...
           @if(menu_access('Departments'))
            ...
            {{--Employee--}}
            <li class="has-sub @if(Request::path()== 'employees/all' OR Request::path()=='employees/add' OR Request::path()=='employees/view/'.view_id() OR Request::path()=='employees/device' OR Request::path()=='employees/roles' OR Request::path()=='employees/set-roles/'.view_id()) sub-open init-sub-open @endif">
                ...
                <ul class="sub">
                    ...
                    <li @if(Request::path()== 'employees/device' OR Request::path()==''.view_id()) class="active" @endif><a href={{url('employees/device')}}><span class="menu-text">{{language_data('Device')}}</span> <span class="menu-thumb"><i class="fa fa-upload"></i></span></a></li>

                </ul>
            </li>
            @endif
            @if(menu_access('Schedules'))
            {{--Schedule--}}
            <li class="has-sub @if(Request::path()== 'settings/schedule' OR Request::path()=='settings/shift' OR Request::path()=='settings/shiftin-plan') sub-open init-sub-open @endif">
                <a href="#"><span class="menu-text">{{language_data('Schedule & Shift')}}</span> <span class="arrow"></span><span class="menu-thumb"><i class="fa fa-calendar-check-o"></i></span></a>
                <ul class="sub">
                    <li @if(Request::path()== 'settings/schedule') class="active" @endif><a href={{route('schedule.index')}}><span class="menu-text">{{language_data('Schedule')}}</span> <span class="menu-thumb"><i class="fa fa-calendar-o"></i></span></a></li>
                    
                    <li @if(Request::path()== 'settings/shift' ) class="active" @endif><a href={{route('shift.index')}}><span class="menu-text">{{language_data('Shift')}}</span> <span class="menu-thumb"><i class="fa fa-calendar-o"></i></span></a></li>
                    
                    <li @if(Request::path()== 'settings/shiftin-plan' ) class="active" @endif><a href={{route('shiftin-plan.index')}}><span class="menu-text">{{language_data('Shifting Plan')}}</span> <span class="menu-thumb"><i class="fa fa-calendar"></i></span></a></li>
            ...
            {{--Reports--}}
            <li class="has-sub @if(Request::path()== 'reports/payroll' OR Request::path()== 'reports/attendance-daily-present' OR Request::path()== 'reports/get-salary-statement' OR Request::path()== 'reports/attendance-monthly'  OR Request::path()== 'reports/attendance-month-wise' OR Request::path()=='reports/employee-summery/'.view_id() OR Request::path()=='reports/job-applicants') sub-open init-sub-open @endif">
                ...
                <ul class="sub">
                    <li class="has-sub "><a href="#"><span class="menu-text">{{language_data('Attendance')}}</span><span class="menu-thumb"><i class="fa fa-calendar-check-o"></i></span></a>

                        <ul class="sub">
                            <li @if(Request::path()== 'reports/attendance-date-wise') class="active" @endif><a href={{url('reports/attendance-daily-present')}}><span class="menu-text">{{language_data('Daily Present')}}</span> <span class="menu-thumb"></span></a></li>
                            <li @if(Request::path()== 'reports/attendance-date-wise') class="active" @endif><a href={{url('reports/attendance-date-wise')}}><span class="menu-text">{{language_data('Employee Date wise')}}</span> <span class="menu-thumb"></span></a></li>
                            <li @if(Request::path()== 'reports/attendance-month-wise') class="active" @endif><a href={{url('reports/attendance-month-wise')}}><span class="menu-text">{{language_data('Employee Month wise')}}</span> <span class="menu-thumb"></span></a></li>
                            <li @if(Request::path()== 'reports/attendance-monthly') class="active" @endif><a href={{url('reports/attendance-monthly')}}><span class="menu-text">{{language_data('Monthly')}}</span> <span class="menu-thumb"></span></a></li>
                        </ul>
                ...
                <ul class="dropdown-menu user-dropdown arrow" role="menu">
                    ...
                    <li>
                        <a href="{{url('leave/edit/'.$l->id)}}">
                            @if($l->employee->avatar!='')
                                <img class="user-thumb" src="<?php echo asset('assets/employee_pic/'.$l->employee->avatar); ?>" alt="{{$l->employee->fname}} {{$l->employee->lname}}">
                            @else
                                <img class="user-thumb" src="<?php echo asset('assets/employee_pic/user.png'); ?>" alt="{{$l->employee->fname}} {{$l->employee->lname}}">
                            @endif

                            <div class="user-name">{{$l->employee->fname}} {{$l->employee->lname}}</div>
                        </a>
                    </li>
