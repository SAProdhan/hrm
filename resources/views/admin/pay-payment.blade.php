...
@section('content')
    ...
    <section class="wrapper-bottom-sec">
        <div class="p-30">
            <h2 class="page-title">{{language_data('Pay Payment to')}} {{$employee->fname.' '.$employee->lname}}</h2>
        </div>
                    ...
                    <div class="panel">
                        <div class="panel-body">
                            <form class="" role="form" method="post" action="{{url('payroll/pay-payment-post')}}">
                                ...
                                @if($attendance_panelty)
                                <div class="form-group">
                                    <label>{{language_data('Attendance panelty')}}</label>
                                    <span class="help">Pay In {{app_config('Currency')}}</span>
                                    <input type="text" class="form-control" readonly value="{{$attendance_panelty}}" name="attendance_panelty">
                                </div>
                                @endif
