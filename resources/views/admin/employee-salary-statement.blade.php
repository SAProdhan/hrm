						...
						<div class="panel-body p-none">
							<table class="table table-condensed">
								<tbody>
									...
									<tr>
										<td><strong>{{language_data('Attendance Panelty')}}:</strong> <span class="pull-right">{{app_config('Currency')}} {{str_replace('.00','',$attendance_panelty)}}</span></td>
									</tr>
									<tr>
                        ...
                        <form class="form-some-up" role="form" method="post" action="{{url('reports/send-sms-salary-statement')}}">
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    {{language_data('Attendance Panelty')}} : {{app_config('CurrencyCode')}} {{str_replace('.00','',$attendance_panelty)}}
