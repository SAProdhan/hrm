        ...
        <div class="p-30 p-t-none p-b-none">
            ...
            <table class="table table-condensed table-transparent table-condensed-slim table-bordered">
                ...
                <tr class="item-row">
                    ...
                    <td align="right" colspan="3">{{app_config('Currency')}} {{$payslip->net_salary}}</td>
                </tr>

                <tr class="item-row">
                    <td class="description">{{language_data('Overtime Amount')}}</td>
                    <td align="right" colspan="3">{{app_config('Currency')}} {{$payslip->overtime_salary}}</td>
                </tr>

                <tr>
                    <td class="td-b-none"></td>
                    <td align="right" colspan="2" class="td-b-r-none">{{language_data('Subtotal')}}</td>
                    <td align="right" class="td-b-l-none">{{app_config('Currency')}} {{$payslip->net_salary+$payslip->overtime_salary}}</td>
                </tr>

                <tr>
                    <td class="td-b-none"></td>
                    <td align="right" colspan="2" class="td-b-r-none">{{language_data('TAX')}}</td>
                    <td align="right" class="td-b-l-none">{{app_config('Currency')}} {{$payslip->tax}}</td>
                </tr>

                <tr>
                    <td class="td-b-none"></td>
                    <td align="right" colspan="2" class="td-b-r-none">{{language_data('Provident Fund')}}</td>
                    <td align="right" class="td-b-l-none">{{app_config('Currency')}} {{$payslip->provident_fund}}</td>
                </tr>

                <tr>
                    <td class="td-b-none"></td>
                    <td align="right" colspan="2" class="td-b-r-none">{{language_data('Loan')}}</td>
                    <td align="right" class="td-b-l-none">{{app_config('Currency')}} {{$payslip->loan}}</td>
                </tr>
                ...
                <tr>
                    ...
                    <td align="right" class="td-b-l-none">{{app_config('Currency')}} {{$payslip->total_salary}}</td>
                </tr>
