                ...
                <div class="col-lg-12">
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            <form class="" role="form" method="post" action="{{url('reports/attendance-date-wise')}}">
                                <div class="row">
                                    <div class="col-sm-2">
                ...
                <div class="col-lg-12">
                    <div class="panel">
                        ...
                        <div class="panel-heading">
                            ...
                            <a href="{{url('reports/attendance-date-wise-pdf/'.$date_from.'_'.$date_to.'/'.$emp_id)}}" class="btn btn-success btn-xs pull-right"><i class="fa fa-file-pdf-o"></i> {{language_data('Generate PDF')}}</a><br>
                            @endif
                        </div>
                        ...
                        <div class="row" style="padding-left:20px; padding-bottom:20px">
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-12 text-center"><H1>Attendance Report</H1></div>
                                </div>
                                <h4>Employee Information:</h4>
                                 <div class="row">
                                     <div class="col-md-3">Name</div>
                                     <div class="col-md-9">: {{$employee->fname}} {{$employee->lname}}</div>
                                 </div>
                                 <div class="row">
                        ...
                        <h4 style="padding-left:20px;">Report summary: <small>Datewise report From {{get_date_format($date_from)}} To {{get_date_format($date_to)}}</small></h4>
                        <h6></h6>
