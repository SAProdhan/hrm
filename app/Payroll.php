...
class Payroll extends Model
{
    ...
    protected $fillable=['emp_id','department','designation','payment_month','payment_date','net_salary', 'attendance_panelty', 'overtime_salary','total_salary','payment_type','tax','provident_fund','loan'];
