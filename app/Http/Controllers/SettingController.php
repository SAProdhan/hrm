...
class SettingController extends Controller
{
    ...
    public function general()
    {
        ...
        $award=Award::all();
        $devices=Device::all();
        return view('admin.system-setting',compact('expense_title','leave_type','award', 'devices'));
    }
    ...
    public function postOfficeTime(Request $request)
    {
        ...
        $validated = $request->validate([
            ...
            'office_in_time' => 'required',
            'rest_in_time' => 'required',
            'rest_out_time' => 'required',
            'WeeklyHoliday' => 'required',
            'MaxOverTime' => 'required',
        ]);

        $office_in_time=Input::get('office_in_time');
        $office_out_time=Input::get('office_out_time');

        $rest_in_time=Input::get('rest_in_time');
        $rest_out_time=Input::get('rest_out_time');
        $WeeklyHoliday=Input::get('WeeklyHoliday');
        $MaxOverTime=Input::get('MaxOverTime');
        ...
        if ($MaxOverTime != '') {
            AppConfig::where('setting', '=', 'MaxOverTime')->update(['value' => $MaxOverTime]);
        }
        ...
        {
            AppConfig::updateOrInsert(
                ['setting' => 'WeeklyHoliday'],
                ['value' => serialize($WeeklyHoliday)]
            );
        }
